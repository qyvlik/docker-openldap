...
2. [testdb_metadata.sql](https://github.com/openldap/openldap/blob/OPENLDAP_REL_ENG_2_4_57/servers/slapd/back-sql/rdbms_depend/mysql/testdb_metadata.sql)
